                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="bg-white rounded-2xl border border-slate-200/60 p-5 shadow-3xs">
                                            <div class="flex items-center justify-between gap-2 flex-wrap mb-3">
                                                <div class="flex items-center gap-2">
                                                    <span class="text-xs font-bold text-slate-900 leading-none">{{ $reply->user->name }}</span>
                                                    <span class="text-[8px] px-2 py-0.5 rounded font-bold uppercase tracking-wider {{ $reply->user->role === 'admin' ? 'bg-slate-950 text-white shadow-3xs' : ($reply->user->role === 'customer' ? 'bg-slate-200 text-slate-700' : 'bg-emerald-50 text-emerald-800 border border-emerald-100') }}">
                                                        {{ $reply->user->role }}
                                                    </span>
                                                </div>
